        ...
        `
{
  ...
  } catch (e) { console.warn('[stealth] chrome.app:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] chrome.csi:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] chrome.loadTimes:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] chrome.runtime:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] iframe.contentWindow:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] media.codecs:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] navigator.hardwareConcurrency:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] navigator.languages:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] navigator.permissions:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] navigator.plugins:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] navigator.vendor:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] navigator.webdriver:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] webgl.vendor:', e.message); }
  ...
  } catch (e) { console.warn('[stealth] window.outerdimensions:', e.message); }
